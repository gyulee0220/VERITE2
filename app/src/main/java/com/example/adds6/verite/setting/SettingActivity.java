package com.example.adds6.verite.setting;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ntb_Newsfeed.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(SettingActivity.this,NewsfeedActivity.class);
        ...
        ntb_favorite.setOnClickListener(new Button.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                Intent intent2 = new Intent(SettingActivity.this,FavorityActivity.class);
        ...
        ntb_search.setOnClickListener(new Button.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                Intent intent3 = new Intent(SettingActivity.this,SearchActivity.class);
