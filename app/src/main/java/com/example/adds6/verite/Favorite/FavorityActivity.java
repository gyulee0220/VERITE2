package com.example.adds6.verite.Favorite;
...
public class FavorityActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ntb_favorite.setOnClickListener(new Button.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                Intent intent2 = new Intent(FavorityActivity.this,FavorityActivity.class);
        ...
        */
        ...
        ntb_setting.setOnClickListener(new Button.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                Intent intent4 = new Intent(FavorityActivity.this,SettingActivity.class);
